...
import com.example.paper.paperinteractive.ChildListItemActivity;
...
public class ChildListItemFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        childName.setText(parentActivity.e.getName());
        childAge.setText("Ålder: " + parentActivity.e.getAge());
